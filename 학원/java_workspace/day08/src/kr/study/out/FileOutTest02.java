...
public class FileOutTest02 {
	...
	public static void main(String[] args) {
		...
		//(쓸파일, 이어쓰기 설정)-> 이어쓰기 설정 기본설정을 false
		try(FileOutputStream out = new FileOutputStream("outTest.txt");
				BufferedOutputStream bo = new BufferedOutputStream(out)){ //파일을 만들기 전 
